...
public class AuthenticateListener extends Listener {
	...
	public void onInit(Controller controller) {
        ...
        String headerStr = "timestamp # numHands # wid_RH # pitch_RH # yaw_RH"
                ...
                + " # gest_swipeDir # gest_swipeVel # gest_KTapDir # gest_STapDir";
	...
	public void onFrame(Controller controller) {
		...
		for (int i = 0; i < 20; i++) {
			data[i + 87] = String.valueOf(boneWid[i]);
		}
		for (int i = 0; i < 20; i++) {
			data[i + 107] = String.valueOf(boneWid[i + 20]);
		}

		// Write gesture info to data
		String type = String.valueOf(gestProp[0]);
		switch (type) {
			case "0": //circle
				data[126] = String.valueOf(gestProp[1]);
				data[127] = String.valueOf(gestProp[2]);
			case "1": //swipe
